...
public class GtfsRelationalMapDbDaoImpl extends GtfsDaoImpl implements
  ...
  public List<String> getTripAgencyIdsReferencingServiceId(AgencyAndId serviceId) {
    ...
    if (_tripAgencyIdsByServiceId == null) {
      ...
      Map<AgencyAndId, Set<String>> agencyIdsByServiceIds = DBMaker.<AgencyAndId, Set<String>>newTempTreeMap();
      ...
      _tripAgencyIdsByServiceId = DBMaker.<AgencyAndId, List<String>>newTempTreeMap();
  ...
  public List<Stop> getStopsForStation(Stop station) {
    if (_stopsByStation == null) {
      _stopsByStation = DBMaker.<Stop, List<Stop>>newTempTreeMap();
  ...
  public List<Trip> getTripsForBlockId(AgencyAndId blockId) {
    ...
    if (_tripsByBlockId == null) {
      _tripsByBlockId = DBMaker.<AgencyAndId, List<Trip>>newTempTreeMap();
      for (Trip trip : getAllTrips()) {
  ...
  private static <K, V, C extends Collection<V>, CIMPL extends C> Map<K, C> mapToValueCollection(
    ...
    Map<K, C> byKey = DBMaker.<K, C>newTempTreeMap();
